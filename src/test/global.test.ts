...
suiteSetup(async function (this: mocha.Context): Promise<void> {
    ...
    console.log("TODO: make sure extension is activated");
    // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
    assert(vscode.extensions.getExtension('ms-azuretools.vscode-azure-agent')!.isActive, "Extension not activated");
});
