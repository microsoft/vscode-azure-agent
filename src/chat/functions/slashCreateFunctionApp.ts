...
async function determineRuntime(_userContent: string, _projectInfo: object | undefined, _ctx: vscode.ChatAgentContext, _progress: vscode.Progress<vscode.ChatAgentExtendedProgress>, _token: vscode.CancellationToken): Promise<string | undefined> {
